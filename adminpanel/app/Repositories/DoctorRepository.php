...
final class DoctorRepository extends Model implements DoctorRepositoryInterface
{
    ...
    private function buildFilters(array $filters): array
    {
        ...
        if (!empty($filters['q'])) {
            $clauses[] = '(d.name LIKE :q_name OR d.designation LIKE :q_desig OR d.qualification LIKE :q_qual OR d.registration_number LIKE :q_reg OR d.slug LIKE :q_slug)';
            $like = '%' . $filters['q'] . '%';
            $params['q_name'] = $like;
            $params['q_desig'] = $like;
            $params['q_qual'] = $like;
        ...
        if (!empty($filters['gender']) && in_array($filters['gender'], Doctor::GENDERS, true)) {
            $clauses[] = 'd.gender = :gender';
